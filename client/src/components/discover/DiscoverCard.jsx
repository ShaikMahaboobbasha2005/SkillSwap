...
export default function DiscoverCard({ user }) {
  ...
  return (
    <>
        ...
        <div className="px-5 pb-5 pt-0">
          <div className="flex items-center gap-2 pt-3 border-t border-[#E6E3DA]/60">
            ...
            <button
              ...
              className="h-9 px-3.5 text-xs font-semibold text-white bg-[#1B4332] hover:bg-[#143326] rounded-xl transition-all flex items-center justify-center gap-1.5 cursor-pointer active:scale-[0.98] shadow-2xs shrink-0"
      ...
      {/* Interactive Swap Requests Coming Soon Modal */}
      <Modal
      ...
      >
        <div className="p-6 text-center space-y-4 bg-white text-[#16160F]">
          ...
          <div className="space-y-1">
            <h3 className="text-base font-bold text-[#16160F]">
              Swap Requests Coming Soon!
            </h3>
            <p className="text-xs text-[#6B6858] leading-relaxed">
              Direct skill swap proposals with <span className="font-bold text-[#16160F]">{name}</span> will be enabled in Phase 6.
            </p>
          </div>
          ...
          <div className="pt-2 border-t border-[#E6E3DA]">
            <Link
              ...
              className="w-full py-2.5 px-4 text-xs font-semibold text-white bg-[#1B4332] hover:bg-[#143326] rounded-xl transition-all flex items-center justify-center gap-1 cursor-pointer shadow-2xs"
            >
              <span>View {name}'s Full Profile</span>
